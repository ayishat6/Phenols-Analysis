...
#BPF
summary(FullData_allcycles$URXBPF, na.rm = FALSE)
#BPS
summary(FullData_allcycles$URXBPs, na.rm = FALSE)
#BP3
summary(FullData_allcycles$URXBP3, na.rm = FALSE)
#TRS
summary(FullData_allcycles$URXTRS, na.rm = FALSE)
#BUP
summary(FullData_allcycles$URXBUP, na.rm = FALSE)
#EPB
summary(FullData_allcycles$URXEPB, na.rm = FALSE)
#MPB
summary(FullData_allcycles$URXMPB, na.rm = FALSE)
#PPB
summary(FullData_allcycles$URXPPB, na.rm = FALSE)
```
...
metabolites <- list(
  ...
  BPF = list(raw_col = "URXMC1", flag_col = "URDBPFLC", lod = 0.2),
  BPS = list(raw_col = "URXMEP", flag_col = "URDBPSLC", lod = 0.1),
  BP3 = list(raw_col = "URXMHP", flag_col = "URDBP3LC", lod = 0.4),
  TRS = list(raw_col = "URXMIB", flag_col = "URDTRSLC", lod = 1.7),
  BUP = list(raw_col = "URXMZP", flag_col = "URDBUPLC", lod = 0.1),
  EPB = list(raw_col = "URXMHH", flag_col = "URDEPBLC", lod = 1.0),
  MPB = list(raw_col = "URXMOH", flag_col = "URDMPBLC", lod = 1.0),
...
write_csv(FullData_allcycles, "Phenols-Analysis/Phenols_DataClean/FullData_allcyclesFINAL.csv")
```
