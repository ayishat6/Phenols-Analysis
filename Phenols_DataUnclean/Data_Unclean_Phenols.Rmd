...
demo03_04C<- demo03_04 %>% 
  select(SEQN,RIAGENDR,RIDAGEYR,RIDRETH1,DMDEDUC2, DMDEDUC3,INDFMPIR, SDMVPSU,SDMVSTRA,SDDSRVYR ) %>%
  arrange(SEQN)
...
write_csv(FullData_allcycles,"~/Documents/Github/Phenols-Analysis/Phenols_DataUnclean/FullData_allcycles.csv") #replace with your path name for folder


summary(FullData_allcycles$SD)
```
